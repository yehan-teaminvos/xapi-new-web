...
import { softwareLicenseAgreement } from "@/data/license-agreement";
    ...
    <>
      <div className="max-2xl:container 2xl:max-w-[1320px] px-5 mx-auto text-left lg:pt-31 lg:pb-8 py-18">
        ...
        <p className="font-helvetica text-base sm:text-xl mb-10 leading-relaxed sm:leading-8 lg:leading-[35px]">
          This Xapi End User License Agreement (“Agreement”) is a legal
          agreement between you who uses or subscribes Xapi (“User” or
          “Subscriber”) and X-venture Global Solutions Pvt Ltd, registered in
          Sri Lanka bearing registration number: PV00233880, with its principal
          place of business at No 1185/1/E, Vidyala Junction, Pannipitiya, Sri
          Lanka (“Company”, “we”, or “us”). If you are an individual accepting
          ...
          to the terms of this Agreement and “You” or “Your” will refer to that
          entity hereafter.
        </p>
        <p className="font-helvetica text-base sm:text-xl mb-10 leading-relaxed sm:leading-8 lg:leading-[35px]">
          By subscribing to, accessing, or using Xapi (the “Software”), you
          agree to be bound by the terms of this Agreement. If you do not agree
          to these terms, you must not access or use the Software.
        </p>
        ...
        <div className="space-y-10">
          {softwareLicenseAgreement.sections?.map((section, index) => (
