...
export default function SparklesEffect({
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="/media/solutions/card-star-white.png"
          alt="star-1"
          width={84}
          height={81}
          className={cn("h-[26px] md:h-[28px] w-auto", imageOneStyles)}
        />
      </motion.div>
      ...
      >
        <Image
          ...
          width={84}
          height={81}
          className={cn("h-[20px] md:h-[22px] w-auto", imageTwoStyles)}
        />
      </motion.div>
      ...
      >
        <Image
          ...
          width={84}
          height={81}
          className={cn("h-[21px] md:h-[23px] w-auto", imageThreeStyles)}
        />
      </motion.div>
    </div>
  );
